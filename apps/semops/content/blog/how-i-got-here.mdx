...
[What is SemOps](../framework/what-is-semops.md) at this stage? It's a structured approach with methods, principles, architectural patterns, and implementation code. It's open source and available through [SemOps-ai on GitHub](https://github.com/semops-ai). It's built using its own principles, and I'm building the plane while flying.
...
- [What is SemOps?](../framework/what-is-semops.md) — The framework definition and overview
- [Why SemOps?](../framework/why-semops.md) — The full case for why meaning matters
- [The Semantic Funnel](../framework/semantic-funnel.md) — The mental model behind the framework
- [The Framework](../framework/framework.md) — Full treatment of all pillars
