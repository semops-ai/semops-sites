...
| ------- | ---------- | --------- | ---------- |
| **pydantic** | semops-core | `source_config.py`, `api/query.py` | Source Configuration, Query API | | | semops-publisher | `config.py` | Publishing Configuration | | | semops-backoffice | `voice/shared/schemas.py` | Voice Control Models |
| **click** | semops-publisher | `publish.py`, `export_pdf.py` | Publishing CLI, PDF Export | | | semops-data | `cli.py` | Data Toolkit CLI |
