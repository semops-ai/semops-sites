...
**What kind of system is it?** Pick one of <a href="https://github.com/semops-ai/semops-docs/blob/main/SEMANTIC_OPERATIONS_FRAMEWORK/STRATEGIC_DATA/data-system-classification.md" target="_blank" rel="noopener noreferrer">four system types</a> that capture "data systems":
