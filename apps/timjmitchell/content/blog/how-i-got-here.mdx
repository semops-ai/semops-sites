...
author: "Tim Mitchell"
category: "Industry"
tags: ["semops", "founder", "narrative"]
excerpt: "The journey from product management to building the Semantic Operations Framework."
---
...
[What is SemOps](https://semops.ai/framework/what-is-semops) at this stage? It's a structured approach with methods, principles, architectural patterns, and implementation code. It's open source and available through [SemOps-ai on GitHub](https://github.com/semops-ai). It's built using its own principles, and I'm building the plane while flying.
...
- [What is SemOps?](https://semops.ai/framework/what-is-semops) — The framework definition and overview
- [Why SemOps?](https://semops.ai/framework/why-semops) — The full case for why meaning matters
- [The Semantic Funnel](https://semops.ai/framework/semantic-funnel) — The mental model behind the framework
- [The Framework](https://semops.ai/framework/framework) — Full treatment of all pillars
